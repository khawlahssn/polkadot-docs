...
- An image or file to store (under ~8 MiB; for larger files, see [Size Limits](/reference/polkadot-hub/data-storage/#size-limits))
...
=== "Console UI"
    ...
    1. Navigate to the [Bulletin Chain Console](https://paritytech.github.io/polkadot-bulletin-chain/){target=\_blank} and click **Connect** to connect your wallet
        ...
        ![Connect wallet to the Bulletin Chain Console](/images/chain-interactions/store-data/bulletin-chain/console-connect-wallet.webp)
    ...
    3. Under **Authorize Account**, enter the desired number of **Transactions** and **Bytes** for your storage needs, then click **Authorize Account**
        ...
        ![Faucet authorize account form](/images/chain-interactions/store-data/bulletin-chain/faucet-authorize-account.webp)

    4. Approve the transaction in your wallet extension. You should see a success confirmation

        ![Authorization success confirmation](/images/chain-interactions/store-data/bulletin-chain/faucet-authorization-success.webp)

    5. To verify your authorization, switch to the **Accounts** tab to view your remaining transactions, bytes, and expiration block

        ![Your authorization details](/images/chain-interactions/store-data/bulletin-chain/faucet-your-authorization.webp)
...
=== "Console UI"
    ...
    1. Navigate to the **Upload** page in the [Bulletin Chain Console](https://paritytech.github.io/polkadot-bulletin-chain/){target=\_blank}. You can see your account's storage usage and authorization quota on the right side panel
        ...
        ![Upload page with drag-and-drop area](/images/chain-interactions/store-data/bulletin-chain/upload-empty.webp)

    2. Select the **File** tab, then drag and drop your image or click to browse. The UI shows the file name and size

        ![File selected for upload](/images/chain-interactions/store-data/bulletin-chain/upload-file-selected.webp)
    ...
    5. On success, the UI displays your **CID**, **Block Number**, and **Transaction Index**
        ...
        ![Upload success with CID and renewal info](/images/chain-interactions/store-data/bulletin-chain/upload-success.webp)
...
![Block Explorer showing the TransactionStorage.Stored event](/images/chain-interactions/store-data/bulletin-chain/explorer-stored-event.webp)
...
=== "Console UI"
    ...
    4. Click **Fetch Data** to retrieve your content. The UI also generates a direct **Gateway Link** you can open in your browser
        ...
        ![Download page with CID entered and gateway link](/images/chain-interactions/store-data/bulletin-chain/download-ipfs-gateway.webp)
...
=== "Direct P2P (Helia)"
    ...
    For production applications, the recommended decentralized approach is to connect directly to Bulletin Chain validator nodes using [Helia](https://helia.io/){target=\_blank} (a lean IPFS implementation) and retrieve data via the CID over libp2p.
...
=== "Console UI"
    ...
    2. Select your stored transaction from the **Load from History** dropdown, or manually enter the **Block Number** and **Transaction Index**
        ...
        ![Renew page with transaction loaded from history](/images/chain-interactions/store-data/bulletin-chain/renew-find-transaction.webp)

    3. Click **Lookup Transaction** to view the transaction details, including the content hash, size, and expiration status

        ![Transaction details with expiration status and renew button](/images/chain-interactions/store-data/bulletin-chain/renew-transaction-details.webp)
